...
import com.ciicgat.sdk.gconf.remote.InnerJson;
...
public class ConfigCollectionTest {
    ...
    public void testJson() {
        ...
        RedisSettingT bean3 = configCollection.getBean(key, content -> InnerJson.parse(content, RedisSettingT.class));
        RedisSettingT bean4 = configCollection.getBean(key, content -> InnerJson.parse(content, RedisSettingT.class));
    ...
    public void testNotExist() {
        ...
        Assert.assertNull(configCollection.getBean(keyNotExist, content -> InnerJson.parse(content, SessionProp.class)));
